...
development partition.  This module deliberately contains no test evaluation
function.
"""
...
def _prepare_dataset(
    ...
    if dataset == "ucr_wafer":
        ...
        raise ValueError("dataset must be 'ucr_wafer' or 'secom'")
    manifest = {
        ...
        "outer_seed": outer_seed if dataset == "secom" else None,
...
__all__ = [
    "INNER_SPLITS", "N_CANDIDATES", "QUANTUM_CANDIDATES",
